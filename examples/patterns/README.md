...
| [Egress after read](./egress-after-read.md) | Govern what a tool *returns* — decide on the result's classification after the fetch, in the audit trail. | [`egress-after-read.suite.json`](./suites/egress-after-read.suite.json) + [`egress-after-read.mjs`](./scripts/egress-after-read.mjs) |
